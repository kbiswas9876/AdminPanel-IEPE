...
export function UnifiedPublishModal({
  ...
  const endTimeMinTime = (startDateValue && endDateValue && isSameDay(startDateValue, endDateValue)) ? startDateValue : undefined
  const resultReleaseMinTime = (endDateValue && resultDateValue && isSameDay(endDateValue, resultDateValue)) ? endDateValue : ((startDateValue && resultDateValue && isSameDay(startDateValue, resultDateValue)) ? startDateValue : undefined)
